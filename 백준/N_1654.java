//백준 1654번
//이진탐색 문제 (정답을 유추한 후 그것을 가지고 이분 탐색 실행)
/*문제
...
public class N_1654 {
	...
	static void binarySearch(int[] A, long start, long end, int N) {
		if (start > end)
			return;
		long mid = (start + end) / 2;    //start와 end 모두 int 범위이나 둘이 더하면 범위 벗어남!!
		long cnt = 0;
